...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sistema.votacao.resources.web.rest"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("API do Sistema de Votacao",
                "Esta API é utilizada para testes.",
                "Versão 1.0",
                "https://github.com/RuanAlmeida",
                new Contact("Ruan Silva", "https://github.com/RuanAlmeida/sistema_votacao", "ruanrodrigues@gmail.com"),
                "Permitido uso para testes.",
                "https://github.com/RuanAlmeida",
